...
(
    `quiz_id`       INT(20)     NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `quiz_content`  MEDIUMTEXT  NOT NULL
);

INSERT INTO `quiz` (`quiz_content`)
VALUES ('Combination of strings with binary, XORKey = 235526, given Salt = 98976');
...
VALUES ('Novak Djokovic', 'https://www.atptour.com/-/media/tennis/players/head-shot/2019/djokovic_head_ao19.png', 34,
       ...
       ('Rafael Nadal', 'https://www.atptour.com/-/media/tennis/players/head-shot/2020/nadal_head_ao20.png', 35,
        'Spain',
       ...
       ('Roger Federer', 'https://www.atptour.com/-/media/tennis/players/head-shot/2020/federer_head_ao20.png', 40,
        'Switzerland',
       ...
       ('Dusan Lajovic', 'https://www.atptour.com/-/media/tennis/players/head-shot/2020/lajovic_head_ao20.png', 33,
        'Serbia',
